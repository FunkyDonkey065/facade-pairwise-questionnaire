...
window.SurveyI18n = (() => {
  ...
  const recruitmentTranslations = [
    ...
    ["After the image ratings, optional questions ask about your age group, gender, education, field of work, education and professional experience in the built environment, and time living in Barcelona city. You may leave these questions unanswered. Your answers will not determine eligibility.", "Después de valorar las imágenes, se incluyen preguntas opcionales sobre tu grupo de edad, género, nivel educativo, ámbito de trabajo, formación y experiencia profesional en el entorno construido y tiempo de residencia en Barcelona ciudad. Puedes dejarlas sin responder. Tus respuestas no determinarán si puedes participar.", "Després de valorar les imatges, s'inclouen preguntes opcionals sobre el teu grup d'edat, gènere, nivell educatiu, àmbit de treball, formació i experiència professional en l'entorn construït i temps de residència a Barcelona ciutat. Pots deixar-les sense respondre. Les teves respostes no determinaran si pots participar-hi."],
    ["What is your main current or most recent field of work?", "¿Cuál es tu ámbito de trabajo principal actual o más reciente?", "Quin és el teu àmbit de treball principal actual o més recent?"],
    ["Architecture", "Arquitectura", "Arquitectura"],
    ["Urban design or urban planning", "Diseño urbano o urbanismo", "Disseny urbà o urbanisme"],
    ["Landscape architecture", "Arquitectura del paisaje", "Arquitectura del paisatge"],
    ["Building engineering, construction or surveying", "Ingeniería de la edificación, construcción o topografía", "Enginyeria de l'edificació, construcció o topografia"],
    ["Other design fields", "Otros ámbitos del diseño", "Altres àmbits del disseny"],
    ["Another field of work", "Otro ámbito de trabajo", "Un altre àmbit de treball"],
    ["No work experience yet", "Todavía no tengo experiencia laboral", "Encara no tinc experiència laboral"],
    ["What is your education status in architecture, urban design, urban planning or landscape architecture?", "¿Cuál es tu situación formativa en arquitectura, diseño urbano, urbanismo o arquitectura del paisaje?", "Quina és la teva situació formativa en arquitectura, disseny urbà, urbanisme o arquitectura del paisatge?"],
    ["No education in these fields", "Sin formación en estos ámbitos", "Sense formació en aquests àmbits"],
    ["Currently studying, no qualification completed in these fields", "Estudio actualmente, sin titulación completada en estos ámbitos", "Estudio actualment, sense titulació completada en aquests àmbits"],
    ["Completed a qualification in one of these fields", "He completado una titulación en uno de estos ámbitos", "He completat una titulació en un d'aquests àmbits"],
    ["Other courses or training in these fields", "Otros cursos o formación en estos ámbitos", "Altres cursos o formació en aquests àmbits"],
    ["How many years of professional experience do you have in architecture, urban design, urban planning or landscape architecture?", "¿Cuántos años de experiencia profesional tienes en arquitectura, diseño urbano, urbanismo o arquitectura del paisaje?", "Quants anys d'experiència professional tens en arquitectura, disseny urbà, urbanisme o arquitectura del paisatge?"],
    ["No professional experience in these fields", "Sin experiencia profesional en estos ámbitos", "Sense experiència professional en aquests àmbits"],
    ["Less than one year", "Menos de un año", "Menys d'un any"],
    ["1-2 years", "1-2 años", "1-2 anys"],
    ["3-5 years", "3-5 años", "3-5 anys"],
    ["6-10 years", "6-10 años", "6-10 anys"],
    ["More than 10 years", "Más de 10 años", "Més de 10 anys"],
    ["In which country did you mainly live during childhood and adolescence (ages 0-18)?", "¿En qué país viviste principalmente durante la infancia y la adolescencia (de 0 a 18 años)?", "En quin país vas viure principalment durant la infància i l'adolescència (de 0 a 18 anys)?"],
    ["Multiple countries, with no single main country", "En varios países, sin un único país principal", "En diversos països, sense un únic país principal"],
    ["My country is not listed", "Mi país no aparece en la lista", "El meu país no apareix a la llista"],
    ["An optional question also asks which country you mainly lived in during childhood and adolescence (ages 0-18).", "También se incluye una pregunta opcional sobre el país en el que viviste principalmente durante la infancia y la adolescencia (de 0 a 18 años).", "També s'inclou una pregunta opcional sobre el país on vas viure principalment durant la infància i l'adolescència (de 0 a 18 anys)."],
    ["Afghanistan","Afganistán","Afganistan"],
    ["Åland Islands","Islas Aland","Illes Åland"],
    ["Albania","Albania","Albània"],
    ["Algeria","Argelia","Algèria"],
    ["American Samoa","Samoa Americana","Samoa Americana"],
    ["Andorra","Andorra","Andorra"],
    ["Angola","Angola","Angola"],
    ["Anguilla","Anguila","Anguilla"],
    ["Antarctica","Antártida","Antàrtida"],
    ["Antigua & Barbuda","Antigua y Barbuda","Antigua i Barbuda"],
    ["Argentina","Argentina","Argentina"],
    ["Armenia","Armenia","Armènia"],
    ["Aruba","Aruba","Aruba"],
    ["Australia","Australia","Austràlia"],
    ["Austria","Austria","Àustria"],
    ["Azerbaijan","Azerbaiyán","Azerbaidjan"],
    ["Bahamas","Bahamas","Bahames"],
    ["Bahrain","Baréin","Bahrain"],
    ...
    ["Bosnia & Herzegovina","Bosnia y Herzegovina","Bòsnia i Hercegovina"],
    ["Botswana","Botsuana","Botswana"],
    ["Bouvet Island","Isla Bouvet","Illa Bouvet"],
    ["Brazil","Brasil","Brasil"],
    ["British Indian Ocean Territory","Territorio Británico del Océano Índico","Territori Britànic de l’Oceà Índic"],
    ["British Virgin Islands","Islas Vírgenes Británicas","Illes Verges Britàniques"],
    ["Brunei","Brunéi","Brunei"],
    ["Bulgaria","Bulgaria","Bulgària"],
    ["Burkina Faso","Burkina Faso","Burkina Faso"],
    ["Burundi","Burundi","Burundi"],
    ["Cambodia","Camboya","Cambodja"],
    ["Cameroon","Camerún","Camerun"],
    ["Canada","Canadá","Canadà"],
    ["Cape Verde","Cabo Verde","Cap Verd"],
    ["Caribbean Netherlands","Caribe neerlandés","Carib Neerlandès"],
    ["Cayman Islands","Islas Caimán","Illes Caiman"],
    ["Central African Republic","República Centroafricana","República Centreafricana"],
    ["Chad","Chad","Txad"],
    ["Chile","Chile","Xile"],
    ["China","China","Xina"],
    ["Christmas Island","Isla de Navidad","Illa Christmas"],
    ["Cocos (Keeling) Islands","Islas Cocos","Illes Cocos (Keeling)"],
    ["Colombia","Colombia","Colòmbia"],
    ["Comoros","Comoras","Comores"],
    ["Congo - Brazzaville","Congo","Congo - Brazzaville"],
    ["Congo - Kinshasa","República Democrática del Congo","Congo - Kinshasa"],
    ["Cook Islands","Islas Cook","Illes Cook"],
    ...
    ["Eswatini","Esuatini","Eswatini"],
    ["Ethiopia","Etiopía","Etiòpia"],
    ["Falkland Islands (Islas Malvinas)","Islas Malvinas (Islas Falkland)","Illes Falkland (Illes Malvines)"],
    ["Faroe Islands","Islas Feroe","Illes Fèroe"],
    ["Fiji","Fiyi","Fiji"],
    ["Finland","Finlandia","Finlàndia"],
    ["France","Francia","França"],
    ["French Guiana","Guayana Francesa","Guaiana Francesa"],
    ["French Polynesia","Polinesia Francesa","Polinèsia Francesa"],
    ["French Southern Territories","Territorios Australes Franceses","Terres Australs Antàrtiques Franceses"],
    ["Gabon","Gabón","Gabon"],
    ["Gambia","Gambia","Gàmbia"],
    ["Georgia","Georgia","Geòrgia"],
    ...
    ["Guadeloupe","Guadalupe","Guadalupe"],
    ["Guam","Guam","Guam"],
    ...
    ["Haiti","Haití","Haití"],
    ["Heard & McDonald Islands","Islas Heard y McDonald","Illes Heard i McDonald"],
    ["Honduras","Honduras","Hondures"],
    ...
    ["Isle of Man","Isla de Man","Illa de Man"],
    ...
    ["Kyrgyzstan","Kirguistán","Kirguizstan"],
    ["Laos","Laos","Lao"],
    ["Latvia","Letonia","Letònia"],
    ["Lebanon","Líbano","Líban"],
    ...
    ["Mali","Mali","Mali"],
    ["Malta","Malta","Malta"],
    ["Marshall Islands","Islas Marshall","Illes Marshall"],
    ["Martinique","Martinica","Martinica"],
    ["Mauritania","Mauritania","Mauritània"],
    ["Mauritius","Mauricio","Maurici"],
    ["Mayotte","Mayotte","Mayotte"],
    ["Mexico","México","Mèxic"],
    ["Micronesia","Micronesia","Micronèsia"],
    ...
    ["Mozambique","Mozambique","Moçambic"],
    ["Myanmar (Burma)","Myanmar (Birmania)","Myanmar (Birmània)"],
    ["Namibia","Namibia","Namíbia"],
    ["Nauru","Nauru","Nauru"],
    ["Nepal","Nepal","Nepal"],
    ["Netherlands","Países Bajos","Països Baixos"],
    ["New Caledonia","Nueva Caledonia","Nova Caledònia"],
    ["New Zealand","Nueva Zelanda","Nova Zelanda"],
    ["Nicaragua","Nicaragua","Nicaragua"],
    ["Niger","Níger","Níger"],
    ["Nigeria","Nigeria","Nigèria"],
    ["Niue","Niue","Niue"],
    ["Norfolk Island","Isla Norfolk","Illa Norfolk"],
    ["North Korea","Corea del Norte","Corea del Nord"],
    ["North Macedonia","Macedonia del Norte","Macedònia del Nord"],
    ["Northern Mariana Islands","Islas Marianas del Norte","Illes Marianes del Nord"],
    ["Norway","Noruega","Noruega"],
    ["Oman","Omán","Oman"],
    ["Pakistan","Pakistán","Pakistan"],
    ["Palau","Palaos","Palau"],
    ["Palestine","Palestina","Palestina"],
    ["Panama","Panamá","Panamà"],
    ["Papua New Guinea","Papúa Nueva Guinea","Papua Nova Guinea"],
    ["Paraguay","Paraguay","Paraguai"],
    ["Peru","Perú","Perú"],
    ["Philippines","Filipinas","Filipines"],
    ["Pitcairn Islands","Islas Pitcairn","Illes Pitcairn"],
    ["Poland","Polonia","Polònia"],
    ["Portugal","Portugal","Portugal"],
    ["Puerto Rico","Puerto Rico","Puerto Rico"],
    ["Qatar","Catar","Qatar"],
    ["Réunion","Reunión","Illa de la Reunió"],
    ["Romania","Rumanía","Romania"],
    ["Russia","Rusia","Rússia"],
    ["Rwanda","Ruanda","Ruanda"],
    ["Samoa","Samoa","Samoa"],
    ["San Marino","San Marino","San Marino"],
    ["São Tomé & Príncipe","Santo Tomé y Príncipe","São Tomé i Príncipe"],
    ...
    ["Solomon Islands","Islas Salomón","Illes Salomó"],
    ["Somalia","Somalia","Somàlia"],
    ["South Africa","Sudáfrica","Sud-àfrica"],
    ["South Georgia & South Sandwich Islands","Islas Georgia del Sur y Sandwich del Sur","Illes Geòrgia del Sud i Sandwich del Sud"],
    ["South Korea","Corea del Sur","Corea del Sud"],
    ["South Sudan","Sudán del Sur","Sudan del Sud"],
    ["Spain","España","Espanya"],
    ["Sri Lanka","Sri Lanka","Sri Lanka"],
    ["St. Barthélemy","San Bartolomé","Saint-Barthélemy"],
    ["St. Helena","Santa Elena","Santa Helena"],
    ["St. Kitts & Nevis","San Cristóbal y Nieves","Saint Kitts i Nevis"],
    ["St. Lucia","Santa Lucía","Saint Lucia"],
    ["St. Martin","San Martín","Saint Martin"],
    ["St. Pierre & Miquelon","San Pedro y Miquelón","Saint-Pierre-et-Miquelon"],
    ["St. Vincent & Grenadines","San Vicente y las Granadinas","Saint Vincent i les Grenadines"],
    ["Sudan","Sudán","Sudan"],
    ["Suriname","Surinam","Surinam"],
    ["Svalbard & Jan Mayen","Svalbard y Jan Mayen","Svalbard i Jan Mayen"],
    ["Sweden","Suecia","Suècia"],
    ["Switzerland","Suiza","Suïssa"],
    ["Syria","Siria","Síria"],
    ["Taiwan","Taiwán","Taiwan"],
    ["Tajikistan","Tayikistán","Tadjikistan"],
    ...
    ["Tonga","Tonga","Tonga"],
    ["Trinidad & Tobago","Trinidad y Tobago","Trinidad i Tobago"],
    ["Tunisia","Túnez","Tunísia"],
    ["Türkiye","Turquía","Turquia"],
    ["Turkmenistan","Turkmenistán","Turkmenistan"],
    ["Turks & Caicos Islands","Islas Turcas y Caicos","Illes Turks i Caicos"],
    ["Tuvalu","Tuvalu","Tuvalu"],
    ["U.S. Outlying Islands","Islas menores alejadas de EE. UU.","Illes Menors Allunyades dels Estats Units"],
    ["U.S. Virgin Islands","Islas Vírgenes de EE. UU.","Illes Verges dels Estats Units"],
    ["Uganda","Uganda","Uganda"],
    ["Ukraine","Ucrania","Ucraïna"],
    ["United Arab Emirates","Emiratos Árabes Unidos","Emirats Àrabs Units"],
    ["United Kingdom","Reino Unido","Regne Unit"],
    ["United States","Estados Unidos","Estats Units"],
    ["Uruguay","Uruguay","Uruguai"],
    ["Uzbekistan","Uzbekistán","Uzbekistan"],
    ["Vanuatu","Vanuatu","Vanuatu"],
    ["Vatican City","Ciudad del Vaticano","Ciutat del Vaticà"],
    ["Venezuela","Venezuela","Veneçuela"],
    ["Vietnam","Vietnam","Vietnam"],
    ["Wallis & Futuna","Wallis y Futuna","Wallis i Futuna"],
    ["Western Sahara","Sáhara Occidental","Sàhara Occidental"],
    ["Yemen","Yemen","Iemen"],
    ["Zambia","Zambia","Zàmbia"],
    ["Zimbabwe","Zimbabue","Zimbàbue"],
    ...
    ["The current questionnaire and data-collection arrangements have not yet been confirmed against the approved project scope.", "Todavía no se ha confirmado que el cuestionario actual y las condiciones de recogida de datos estén cubiertos por el alcance del proyecto aprobado.", "Encara no s'ha confirmat que el qüestionari actual i les condicions de recollida de dades estiguin coberts per l'abast del projecte aprovat."],
    ["Your coded responses are saved in private Netlify storage. A copy is also sent to Netlify Forms. The research team exports responses to restricted research storage. A necessary cookie remembers your assigned questionnaire for 30 days; the server records your coded assignment, reservation expiry and completion status. This does not identify you across different browsers or devices.", "Tus respuestas codificadas se guardan en un almacenamiento privado de Netlify. También se envía una copia a Netlify Forms. El equipo investigador exporta las respuestas a un almacenamiento de investigación de acceso restringido. Una cookie necesaria recuerda tu cuestionario asignado durante 30 días; el servidor registra tu asignación codificada, el vencimiento de la reserva y el estado de finalización. Esto no te identifica entre distintos navegadores o dispositivos.", "Les teves respostes codificades es desen en un emmagatzematge privat de Netlify. També s'envia una còpia a Netlify Forms. L'equip investigador exporta les respostes a un emmagatzematge de recerca d'accés restringit. Una galeta necessària recorda el qüestionari assignat durant 30 dies; el servidor registra l'assignació codificada, el venciment de la reserva i l'estat de finalització. Això no t'identifica entre navegadors o dispositius diferents."],
