...
window.SurveyI18n = (() => {
  const spanish = new Map(Object.entries({
    ...
    "Research preview: 50 Eixample scenes. Responses are not uploaded.": "Vista previa de investigación: 50 escenas del Eixample. Las respuestas no se envían.",
  ...
  const catalan = new Map(Object.entries({
    ...
    "Research preview: 50 Eixample scenes. Responses are not uploaded.": "Vista prèvia de recerca: 50 escenes de l'Eixample. Les respostes no s'envien.",
